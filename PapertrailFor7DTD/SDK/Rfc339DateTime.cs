...
namespace PapertrailFor7DTD.SDK {
    /**
     * <summary>Provides methods for converting <see cref="DateTime"/> structures to and from the equivalent RFC 3339 string representation.</summary>
     */
    public static class Rfc3339DateTime {
        /**
         * <summary>Private member to hold array of formats that RFC 3339 date-time representations conform to.</summary>
         */
        private static string[] formats = new string[0];

        /**
         * <summary>Private member to hold the DateTime format string for representing a DateTime in the RFC 3339 format.</summary>
         */
        private const string format = "yyyy-MM-dd'T'HH:mm:ss.fffK";

        /**
         * <summary>Gets the custom format specifier that may be used to represent a <see cref="DateTime"/> in the RFC 3339 format.</summary>
        ...
        /**
         * <summary>Gets an array of the expected formats for RFC 3339 date-time string representations.</summary>
         * <value>An array of the expected formats for RFC 3339 date-time string representations that may used in 
         * the <see cref="DateTime.TryParseExact(string, string[], IFormatProvider, DateTimeStyles, out DateTime)"/> method.</value>
         */
        ...
        /**
         * <summary>Converts the specified string representation of a date and time to its <see cref="DateTime"/> equivalent.</summary>
        ...
        /**
         * <summary>Converts the value of the specified <see cref="DateTime"/> object to its equivalent string representation.</summary>
        ...
        public static bool TryParse(string s, out DateTime result) {
            ...
            if (!string.IsNullOrEmpty(s)) {
                if (DateTime.TryParseExact(s, Rfc3339DateTime.Rfc3339DateTimePatterns, DateTimeFormatInfo.InvariantInfo, DateTimeStyles.AdjustToUniversal, out DateTime parseResult)) {
